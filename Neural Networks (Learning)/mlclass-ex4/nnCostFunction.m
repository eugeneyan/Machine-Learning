...
# y is initially a 5000 x 1 vector; expand it into a matrix of 5000 x 10, 
# where a 1s indicate the y value
...
# remove bias terms from Theta1 and Theta2
Theta1a = Theta1(:, 2:end);
Theta2a = Theta2(:, 2:end);

# calculate regularization term
reg_term = sum(sum(Theta1a.^2)) + sum(sum(Theta2a.^2));
